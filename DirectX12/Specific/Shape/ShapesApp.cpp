...
//
//descriptor 0到(n-1) contain the object CBVs for 0th frame resource
//descriptor n到(2n-1) contain the object CBVs for 1st frame resource
//descriptor 2n到(3n-1) contain the object CBVs for 2nd frame resource
//descriptor 3n,3n+1,3n+2 pass CBVs for 0th,1st,2nd frame resource
//
...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Specific\\Shape\\Shaders\\color.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Specific\\Shape\\Shaders\\color.hlsl", nullptr, "PS", "ps_5_0");
...
void ShapesApp::DrawRenderItems(ID3D12GraphicsCommandList * cmdList, const std::vector<RenderItem*>& ritems)
{
	...
	for (size_t i = 0;i < ritems.size();i++) {
		...
		//for this object and this frame resource
