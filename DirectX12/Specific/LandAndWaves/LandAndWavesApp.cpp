...
void LandAndWavesApp::Update(const GameTimer& gt)
{
	...
	//Update resources in mCurrentFrameResource
	UpdateObjectCBs(gt);
	UpdateMainPassCB(gt);
	UpdateWaves(gt);
}
...
void LandAndWavesApp::Draw(const GameTimer & gt)
{
	...
	//Bind per-pass constant buffer. Only need to this once per-pass
...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Specific\\LandAndWaves\\Shaders\\color.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Specific\\LandAndWaves\\Shaders\\color.hlsl", nullptr, "PS", "ps_5_0");
