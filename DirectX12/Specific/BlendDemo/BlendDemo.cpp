...
void BlendApp::BuildShadersAndInputLayout()
{
	...
	mShaders["standardVS"] = d3dUtil::CompileShader(L"Specific\\BlendDemo\\Shaders\\Main.hlsl", nullptr, "VS", "vs_5_0");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"Specific\\BlendDemo\\Shaders\\Main.hlsl", defines, "PS", "ps_5_0");
	mShaders["alphaTestedPS"] = d3dUtil::CompileShader(L"Specific\\BlendDemo\\Shaders\\Main.hlsl", alphaTestDefines, "PS", "ps_5_0");
